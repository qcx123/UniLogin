...
- (UACustomModel *)createCMCCModel:(BOOL)isMini {
    ...
    model.numberTextAttributes = @{NSForegroundColorAttributeName:[UIColor orangeColor],NSFontAttributeName:[UIFont systemFontOfSize:30]};
    ...
    __weak ViewController *weakSelf = self;
        model.authViewBlock = ^(UIView *customView, CGRect numberFrame , CGRect loginBtnFrame,CGRect checkBoxFrame, CGRect privacyFrame) {
            ...
            logo.frame = CGRectMake(0, numberFrame.origin.y - 70, 60, 60);
...
//        model.checkTipText = @"请勾选同意服务条款";
        ...
        model.appPrivacyOriginLR = @[@10,@20];
        //20、隐私的内容模板
        model.appPrivacyDemo = [[NSAttributedString alloc]initWithString:@"登录&&默认&&本界面并同意授权hdhhhhdhddh腾讯协议和百度协议、进行本机号码登录" attributes:@{NSFontAttributeName:[UIFont fontWithName:@"Marion" size:13],NSForegroundColorAttributeName:UIColor.blackColor}];
...
//        model.privacyOffsetY = [NSNumber numberWithFloat:(100/2)];
        //26、隐私条款check框默认状态
        model.privacyState = YES;
        model.webNavReturnImg = [UIImage imageNamed:@"testCloseImg"];
        model.webNavColor = [UIColor  redColor];
        model.webNavTitleAttrs = @{NSForegroundColorAttributeName:[UIColor yellowColor],NSFontAttributeName:[UIFont systemFontOfSize:18 weight:UIFontWeightMedium]};
...
//            CGFloat overallScaleH = UIScreen.mainScreen.bounds.size.height/ 667.f;
    //        CGFloat overallScaleW = UIScreen.mainScreen.bounds.size.width/ 375.f;
        ...
        UIImage *norMal = [UIImage imageNamed:@"timg"];
        UIImage *invalied = [UIImage imageNamed:@"WechatIMG16"];
        model.logBtnImgs = @[norMal,invalied];
    return model;
}
...
- (ZOAUCustomModel *)createCUCCModel:(BOOL)isMini {
    ZOAUCustomModel *model = [[ZOAUCustomModel alloc]init];
    if (isMini) {
...
//        model.bgImage = [self createImageWithColor:UIColor.yellowColor];
        ...
        model.navBgColor = UIColor.orangeColor;
        model.navText = @"自定义标题";
        model.navTextFont = [UIFont boldSystemFontOfSize:15];
        ...
        model.logBtnTextFont =[UIFont boldSystemFontOfSize:30];;
        model.logBtnTextColor = UIColor.redColor;
        model.logBtnOffsetY = 5;
        model.logBtnRadius = 10;
        model.logBtnUsableBGColor = UIColor.greenColor;
        model.logBtnUnusableBGColor = UIColor.lightGrayColor;
    ...
    //    model.logBtnImageDeselected = [UIImage imageNamed:@"btn_check"];
        ...
        model.privacyColor = [UIColor orangeColor];
        model.privacyTextColor  = [UIColor redColor];
...
//        model.dismissTransition = animation;
        ...
        [[ZUOAuthManager getInstance]customUIWithParams:model topCustomViews:^(UIView *customView) {
            ...
            [self setThirdViewWithCustom:customView isSmall:isMini frame:CGRectMake(50, 0, [UIScreen mainScreen].bounds.size.width - 100, 30)];
        }];
    }
    return model;
}
